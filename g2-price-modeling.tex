...
\begin{figure}
\centering\includegraphics[width=1.2\textwidth]{figures/g2-4M-L.png}\caption{ error for g2.2xlarge for ARIMA modeling\label{fig:g2-param-diverse}}
\end{figure}
